  ...
  $packageList = (convertfrom-json(Invoke-WebRequest -UseBasicParsing -Uri  "http://192.168.33.10:5601/api/fleet/epm/packages" -ContentType "application/json" -Headers $headers -Method GET))
